...
The sources for Scrapy Inline Requests can be downloaded from the `Github repo`_.
...
.. _tarball: https://github.com/rolando/scrapy-inline-requests/tarball/master
